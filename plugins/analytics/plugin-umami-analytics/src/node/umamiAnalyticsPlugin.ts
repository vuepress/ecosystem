 ...
 *
 * Integrates Umami Analytics tracking into VuePress applications. Only active
 * in production builds when a valid website ID is provided.
 *
 * 集成 Umami Analytics 追踪到 VuePress 应用中。 仅在生产构建且提供有效网站 ID 时启用。
 *
 * @example
