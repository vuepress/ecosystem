 ...
 * 初始化百度统计追踪
 *
 * Injects Baidu Analytics script and tracks page views automatically. The
 * global `_hmt` array will be available for custom event tracking.
 *
 * 注入百度统计脚本并自动追踪页面浏览。 全局 `_hmt` 数组可用于自定义事件追踪。
 *
