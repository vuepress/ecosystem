...
import type { OramaLocaleData } from '../shared/index.js'

/** Default locale info for `@vuepress/plugin-orama` */
export const oramaLocaleInfo: DefaultLocaleInfo<OramaLocaleData> = [
  [
    ['en', 'en-US'],
    {
      cancel: 'Cancel',
