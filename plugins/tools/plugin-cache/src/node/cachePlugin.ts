...
export interface CachePluginOptions {
   ...
   * Cache type
   *
   * - Using memory caching can achieve the best optimization effects, but the
   *   cost increases as the project grows, occupying more content, suitable for
   *   projects with fewer pages.
   * - For complex projects with many pages, it is recommended to use file
   *   caching.
   *
   * @default 'memory'
   */
 ...
 *
 * This plugin is recommended to be placed after all other plugins to ensure
