  ...
  '/zh/plugins/blog/': [
    {
      ...
      items: ['/zh/plugins/blog/blog/guide', '/zh/plugins/blog/blog/config'],
    },
    {
      text: '评论',
  ...
  '/zh/plugins/pwa/': [
    {
      ...
      items: ['/zh/plugins/pwa/pwa/guide', '/zh/plugins/pwa/pwa/config'],
    },
  ...
  '/zh/plugins/seo/': [
    {
      ...
      items: ['/zh/plugins/seo/seo/guide', '/zh/plugins/seo/seo/config'],
    },
    {
      text: '站点地图',
