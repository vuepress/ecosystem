...
import type { SearchCustomField } from './types.js'

/**
 * Options for generating the index of a page.
 *
 * 生成页面索引的选项。
 */
export interface GeneratePageIndexOptions {
  ...
  /** Tags whose content should be preserved 需要保留内容的标签 */
  preserveTags?: string[]
}
