...
import type { SearchLocaleData } from '../shared/index.js'

/** Default locale info for the search box 搜索框的默认多语言信息 */
export const searchLocaleInfo: DefaultLocaleInfo<SearchLocaleData> = [
  [
    ['en', 'en-US'],
    {
      cancel: 'Cancel',
