...
describe('deep merge', () => {
  it('simple merge', () => {
    ...
    expect(ans1).toStrictEqual({ a: 1, b: 2 })
  ...
  it('merge array', () => {
    ...
    expect(ans2).toStrictEqual({ a: { a: 1 } })
  })
  ...
  it('merge object', () => {
    ...
    expect(ans).toStrictEqual({ a: { a: 1, b: 1, c: 2 } })
  })
  ...
  it('nest merge', () => {
    ...
    expect(ans1).toStrictEqual({ a: { a: 1 } })
  ...
  it('merge multi object', () => {
    ...
    expect(ans).toStrictEqual({ a: { a: 1, b: 0, c: 2 }, b: { a: 1 } })
  })
})
