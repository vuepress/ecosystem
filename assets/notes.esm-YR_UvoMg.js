...
`+e.raw,s.text+=`
`+e.raw,this.inlineQueue[this.inlineQueue.length-1].src=s.text);else if(e=this.tokenizer.table(n))n=n.substring(e.raw.length),t.push(e);else if(e=this.tokenizer.lheading(n))n=n.substring(e.raw.length),t.push(e);else{if(a=n,this.options.extensions&&this.options.extensions.startBlock){let i=1/0;const o=n.slice(1);let c;this.options.extensions.startBlock.forEach(function(h){c=h.call({lexer:this},o),typeof c=="number"&&c>=0&&(i=Math.min(i,c))}),i<1/0&&i>=0&&(a=n.substring(0,i+1))}if(this.state.top&&(e=this.tokenizer.paragraph(a)))s=t[t.length-1],r&&s.type==="paragraph"?(s.raw+=`
`+e.raw,s.text+=`
...
`}strong(n){return`<strong>${n}</strong>`}em(n){return`<em>${n}</em>`}codespan(n){return`<code>${n}</code>`}br(){return this.options.xhtml?"<br/>":"<br>"}del(n){return`<del>${n}</del>`}link(n,t,e){if((n=Z(this.options.sanitize,this.options.baseUrl,n))===null)return e;let s='<a href="'+n+'"';return t&&(s+=' title="'+t+'"'),s+=">"+e+"</a>",s}image(n,t,e){if((n=Z(this.options.sanitize,this.options.baseUrl,n))===null)return e;let s=`<img src="${n}" alt="${e}"`;return t&&(s+=` title="${t}"`),s+=this.options.xhtml?"/>":">",s}text(n){return n}}class V{strong(n){return n}em(n){return n}codespan(n){return n}del(n){return n}html(n){return n}text(n){return n}link(n,t,e){return""+e}image(n,t,e){return""+e}br(){return""}}class F{constructor(){this.seen={}}serialize(n){return n.toLowerCase().trim().replace(/<[!\/a-z].*?>/gi,"").replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,"").replace(/\s/g,"-")}getNextSafeSlug(n,t){let e=n,s=0;if(this.seen.hasOwnProperty(e)){s=this.seen[n];do s++,e=n+"-"+s;while(this.seen.hasOwnProperty(e))}return t||(this.seen[n]=s,this.seen[e]=0),e}slug(n,t={}){const e=this.serialize(n);return this.getNextSafeSlug(e,t.dryrun)}}class ${constructor(n){this.options=n||E,this.options.renderer=this.options.renderer||new O,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new V,this.slugger=new F}static parse(n,t){return new $(t).parse(n)}static parseInline(n,t){return new $(t).parseInline(n)}parse(n,t=!0){let e,s,a,r,i,o,c,h,l,p,w,S,y,T,f,A,L,v,_,x="";const R=n.length;for(e=0;e<R;e++)if(p=n[e],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[p.type]&&(_=this.options.extensions.renderers[p.type].call({parser:this},p),_!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(p.type)))x+=_||"";else switch(p.type){case"space":continue;case"hr":x+=this.renderer.hr();continue;case"heading":x+=this.renderer.heading(this.parseInline(p.tokens),p.depth,K(this.parseInline(p.tokens,this.textRenderer)),this.slugger);continue;case"code":x+=this.renderer.code(p.text,p.lang,p.escaped);continue;case"table":for(h="",c="",r=p.header.length,s=0;s<r;s++)c+=this.renderer.tablecell(this.parseInline(p.header[s].tokens),{header:!0,align:p.align[s]});for(h+=this.renderer.tablerow(c),l="",r=p.rows.length,s=0;s<r;s++){for(o=p.rows[s],c="",i=o.length,a=0;a<i;a++)c+=this.renderer.tablecell(this.parseInline(o[a].tokens),{header:!1,align:p.align[a]});l+=this.renderer.tablerow(c)}x+=this.renderer.table(h,l);continue;case"blockquote":l=this.parse(p.tokens),x+=this.renderer.blockquote(l);continue;case"list":for(w=p.ordered,S=p.start,y=p.loose,r=p.items.length,l="",s=0;s<r;s++)f=p.items[s],A=f.checked,L=f.task,T="",f.task&&(v=this.renderer.checkbox(A),y?f.tokens.length>0&&f.tokens[0].type==="paragraph"?(f.tokens[0].text=v+" "+f.tokens[0].text,f.tokens[0].tokens&&f.tokens[0].tokens.length>0&&f.tokens[0].tokens[0].type==="text"&&(f.tokens[0].tokens[0].text=v+" "+f.tokens[0].tokens[0].text)):f.tokens.unshift({type:"text",text:v}):T+=v),T+=this.parse(f.tokens,y),l+=this.renderer.listitem(T,L,A);x+=this.renderer.list(l,w,S);continue;case"html":x+=this.renderer.html(p.text);continue;case"paragraph":x+=this.renderer.paragraph(this.parseInline(p.tokens));continue;case"text":for(l=p.tokens?this.parseInline(p.tokens):p.text;e+1<R&&n[e+1].type==="text";)p=n[++e],l+=`
`+(p.tokens?this.parseInline(p.tokens):p.text);x+=t?this.renderer.paragraph(l):l;continue;default:{const N='Token with "'+p.type+'" type was not found.';if(this.options.silent)return void console.error(N);throw new Error(N)}}return x}parseInline(n,t){t=t||this.renderer;let e,s,a,r="";const i=n.length;for(e=0;e<i;e++)if(s=n[e],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[s.type]&&(a=this.options.extensions.renderers[s.type].call({parser:this},s),a!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(s.type)))r+=a||"";else switch(s.type){case"escape":case"text":r+=t.text(s.text);break;case"html":r+=t.html(s.text);break;case"link":r+=t.link(s.href,s.title,this.parseInline(s.tokens,t));break;case"image":r+=t.image(s.href,s.title,s.text);break;case"strong":r+=t.strong(this.parseInline(s.tokens,t));break;case"em":r+=t.em(this.parseInline(s.tokens,t));break;case"codespan":r+=t.codespan(s.text);break;case"br":r+=t.br();break;case"del":r+=t.del(this.parseInline(s.tokens,t));break;default:{const o='Token with "'+s.type+'" type was not found.';if(this.options.silent)return void console.error(o);throw new Error(o)}}return r}}class C{constructor(n){this.options=n||E}preprocess(n){return n}postprocess(n){return n}}D(C,"passThroughHooks",new Set(["preprocess","postprocess"]));function Y(d,n){return(t,e,s)=>{typeof e=="function"&&(s=e,e=null);const a={...e},r=function(i,o,c){return h=>{if(h.message+=`
Please report this to https://github.com/markedjs/marked.`,i){const l="<p>An error occurred:</p><pre>"+b(h.message+"",!0)+"</pre>";return o?Promise.resolve(l):c?void c(null,l):l}if(o)return Promise.reject(h);if(!c)throw h;c(h)}}((e={...g.defaults,...a}).silent,e.async,s);if(t==null)return r(new Error("marked(): input parameter is undefined or null"));if(typeof t!="string")return r(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(t)+", string expected"));if(function(i){i&&i.sanitize&&!i.silent&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options")}(e),e.hooks&&(e.hooks.options=e),s){const i=e.highlight;let o;try{e.hooks&&(t=e.hooks.preprocess(t)),o=d(t,e)}catch(l){return r(l)}const c=function(l){let p;if(!l)try{e.walkTokens&&g.walkTokens(o,e.walkTokens),p=n(o,e),e.hooks&&(p=e.hooks.postprocess(p))}catch(w){l=w}return e.highlight=i,l?r(l):s(null,p)};if(!i||i.length<3||(delete e.highlight,!o.length))return c();let h=0;return g.walkTokens(o,function(l){l.type==="code"&&(h++,setTimeout(()=>{i(l.text,l.lang,function(p,w){if(p)return c(p);w!=null&&w!==l.text&&(l.text=w,l.escaped=!0),h--,h===0&&c()})},0))}),void(h===0&&c())}if(e.async)return Promise.resolve(e.hooks?e.hooks.preprocess(t):t).then(i=>d(i,e)).then(i=>e.walkTokens?Promise.all(g.walkTokens(i,e.walkTokens)).then(()=>i):i).then(i=>n(i,e)).then(i=>e.hooks?e.hooks.postprocess(i):i).catch(r);try{e.hooks&&(t=e.hooks.preprocess(t));const i=d(t,e);e.walkTokens&&g.walkTokens(i,e.walkTokens);let o=n(i,e);return e.hooks&&(o=e.hooks.postprocess(o)),o}catch(i){return r(i)}}}function g(d,n,t){return Y(z.lex,$.parse)(d,n,t)}g.options=g.setOptions=function(d){var n;return g.defaults={...g.defaults,...d},n=g.defaults,E=n,g},g.getDefaults=tt,g.defaults=E,g.use=function(...d){const n=g.defaults.extensions||{renderers:{},childTokens:{}};d.forEach(t=>{const e={...t};if(e.async=g.defaults.async||e.async||!1,t.extensions&&(t.extensions.forEach(s=>{if(!s.name)throw new Error("extension name required");if(s.renderer){const a=n.renderers[s.name];n.renderers[s.name]=a?function(...r){let i=s.renderer.apply(this,r);return i===!1&&(i=a.apply(this,r)),i}:s.renderer}if(s.tokenizer){if(!s.level||s.level!=="block"&&s.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");n[s.level]?n[s.level].unshift(s.tokenizer):n[s.level]=[s.tokenizer],s.start&&(s.level==="block"?n.startBlock?n.startBlock.push(s.start):n.startBlock=[s.start]:s.level==="inline"&&(n.startInline?n.startInline.push(s.start):n.startInline=[s.start]))}s.childTokens&&(n.childTokens[s.name]=s.childTokens)}),e.extensions=n),t.renderer){const s=g.defaults.renderer||new O;for(const a in t.renderer){const r=s[a];s[a]=(...i)=>{let o=t.renderer[a].apply(s,i);return o===!1&&(o=r.apply(s,i)),o}}e.renderer=s}if(t.tokenizer){const s=g.defaults.tokenizer||new q;for(const a in t.tokenizer){const r=s[a];s[a]=(...i)=>{let o=t.tokenizer[a].apply(s,i);return o===!1&&(o=r.apply(s,i)),o}}e.tokenizer=s}if(t.hooks){const s=g.defaults.hooks||new C;for(const a in t.hooks){const r=s[a];C.passThroughHooks.has(a)?s[a]=i=>{if(g.defaults.async)return Promise.resolve(t.hooks[a].call(s,i)).then(c=>r.call(s,c));const o=t.hooks[a].call(s,i);return r.call(s,o)}:s[a]=(...i)=>{let o=t.hooks[a].apply(s,i);return o===!1&&(o=r.apply(s,i)),o}}e.hooks=s}if(t.walkTokens){const s=g.defaults.walkTokens;e.walkTokens=function(a){let r=[];return r.push(t.walkTokens.call(this,a)),s&&(r=r.concat(s.call(this,a))),r}}g.setOptions(e)})},g.walkTokens=function(d,n){let t=[];for(const e of d)switch(t=t.concat(n.call(g,e)),e.type){case"table":for(const s of e.header)t=t.concat(g.walkTokens(s.tokens,n));for(const s of e.rows)for(const a of s)t=t.concat(g.walkTokens(a.tokens,n));break;case"list":t=t.concat(g.walkTokens(e.items,n));break;default:g.defaults.extensions&&g.defaults.extensions.childTokens&&g.defaults.extensions.childTokens[e.type]?g.defaults.extensions.childTokens[e.type].forEach(function(s){t=t.concat(g.walkTokens(e[s],n))}):e.tokens&&(t=t.concat(g.walkTokens(e.tokens,n)))}return t},g.parseInline=Y(z.lexInline,$.parseInline),g.Parser=$,g.parser=$.parse,g.Renderer=O,g.TextRenderer=V,g.Lexer=z,g.lexer=z.lex,g.Tokenizer=q,g.Slugger=F,g.Hooks=C,g.parse=g,g.options,g.setOptions,g.use,g.walkTokens,g.parseInline,$.parse,z.lex;const ht=()=>{let d,n,t=null;function e(){if(t&&!t.closed)t.focus();else{if(t=window.open("about:blank","reveal.js - Notes","width=1100,height=700"),t.marked=g,t.document.write(`<!--
...
</html>`),!t)return void alert("Speaker view popup failed to open. Please make sure popups are allowed and reopen the speaker view.");(function(){const i=n.getConfig().url,o=typeof i=="string"?i:window.location.protocol+"//"+window.location.host+window.location.pathname+window.location.search;d=setInterval(function(){t.postMessage(JSON.stringify({namespace:"reveal-notes",type:"connect",state:n.getState(),url:o}),"*")},500),window.addEventListener("message",a)})()}}function s(i){let o=n.getCurrentSlide(),c=o.querySelectorAll("aside.notes"),h=o.querySelector(".current-fragment"),l={namespace:"reveal-notes",type:"state",notes:"",markdown:!1,whitespace:"normal",state:n.getState()};if(o.hasAttribute("data-notes")&&(l.notes=o.getAttribute("data-notes"),l.whitespace="pre-wrap"),h){let p=h.querySelector("aside.notes");p?(l.notes=p.innerHTML,l.markdown=typeof p.getAttribute("data-markdown")=="string",c=null):h.hasAttribute("data-notes")&&(l.notes=h.getAttribute("data-notes"),l.whitespace="pre-wrap",c=null)}c&&c.length&&(c=Array.from(c).filter(p=>p.closest(".fragment")===null),l.notes=c.map(p=>p.innerHTML).join(`
`),l.markdown=c[0]&&typeof c[0].getAttribute("data-markdown")=="string"),t.postMessage(JSON.stringify(l),"*")}function a(i){if(function(o){try{return window.location.origin===o.source.location.origin}catch{return!1}}(i))try{let o=JSON.parse(i.data);o&&o.namespace==="reveal-notes"&&o.type==="connected"?(clearInterval(d),r()):o&&o.namespace==="reveal-notes"&&o.type==="call"&&function(c,h,l){let p=n[c].apply(n,h);t.postMessage(JSON.stringify({namespace:"reveal-notes",type:"return",result:p,callId:l}),"*")}(o.methodName,o.arguments,o.callId)}catch{}}function r(){n.on("slidechanged",s),n.on("fragmentshown",s),n.on("fragmenthidden",s),n.on("overviewhidden",s),n.on("overviewshown",s),n.on("paused",s),n.on("resumed",s),s()}return{id:"notes",init:function(i){n=i,/receiver/i.test(window.location.search)||(window.location.search.match(/(\?|\&)notes/gi)!==null?e():window.addEventListener("message",o=>{if(!t&&typeof o.data=="string"){let h;try{h=JSON.parse(o.data)}catch{}h&&h.namespace==="reveal-notes"&&h.type==="heartbeat"&&(c=o.source,t&&!t.closed?t.focus():(t=c,window.addEventListener("message",a),r()))}var c}),n.addKeyBinding({keyCode:83,key:"S",description:"Speaker notes view"},function(){e()}))},open:e}};export{ht as default};
