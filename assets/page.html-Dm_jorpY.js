import{_ as s,o as n,c as e,e as a}from"./app-rzjRmPdw.js";const l={},p=a(`<h1 id="page-related" tabindex="-1"><a class="header-anchor" href="#page-related"><span>Page Related</span></a></h1><p>These functions generate common information for your pages.</p><h2 id="getpageexcerpt" tabindex="-1"><a class="header-anchor" href="#getpageexcerpt"><span>getPageExcerpt</span></a></h2><p>Get the excerpt of the page.</p><div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre class="shiki dark-plus" style="background-color:#1E1E1E;color:#D4D4D4;" tabindex="0"><code><span class="line"><span style="color:#C586C0;">export</span><span style="color:#569CD6;"> interface</span><span style="color:#4EC9B0;"> PageExcerptOptions</span><span style="color:#D4D4D4;"> {</span></span>
