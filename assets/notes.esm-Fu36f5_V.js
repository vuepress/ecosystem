...
</html>`),!t)return void alert("Speaker view popup failed to open. Please make sure popups are allowed and reopen the speaker view.");(function(){const i=n.getConfig().url,o=typeof i=="string"?i:window.location.protocol+"//"+window.location.host+window.location.pathname+window.location.search;d=setInterval(function(){t.postMessage(JSON.stringify({namespace:"reveal-notes",type:"connect",state:n.getState(),url:o}),"*")},500),window.addEventListener("message",a)})()}}function s(i){let o=n.getCurrentSlide(),c=o.querySelectorAll("aside.notes"),h=o.querySelector(".current-fragment"),l={namespace:"reveal-notes",type:"state",notes:"",markdown:!1,whitespace:"normal",state:n.getState()};if(o.hasAttribute("data-notes")&&(l.notes=o.getAttribute("data-notes"),l.whitespace="pre-wrap"),h){let u=h.querySelector("aside.notes");u?(l.notes=u.innerHTML,l.markdown=typeof u.getAttribute("data-markdown")=="string",c=null):h.hasAttribute("data-notes")&&(l.notes=h.getAttribute("data-notes"),l.whitespace="pre-wrap",c=null)}c&&c.length&&(c=Array.from(c).filter(u=>u.closest(".fragment")===null),l.notes=c.map(u=>u.innerHTML).join(`
`),l.markdown=c[0]&&typeof c[0].getAttribute("data-markdown")=="string"),t.postMessage(JSON.stringify(l),"*")}function a(i){if(function(o){try{return window.location.origin===o.source.location.origin}catch{return!1}}(i))try{let o=JSON.parse(i.data);o&&o.namespace==="reveal-notes"&&o.type==="connected"?(clearInterval(d),r()):o&&o.namespace==="reveal-notes"&&o.type==="call"&&function(c,h,l){let u=n[c].apply(n,h);t.postMessage(JSON.stringify({namespace:"reveal-notes",type:"return",result:u,callId:l}),"*")}(o.methodName,o.arguments,o.callId)}catch{}}function r(){n.on("slidechanged",s),n.on("fragmentshown",s),n.on("fragmenthidden",s),n.on("overviewhidden",s),n.on("overviewshown",s),n.on("paused",s),n.on("resumed",s),n.on("previewiframe",s),n.on("previewimage",s),n.on("previewvideo",s),n.on("closeoverlay",s),s()}return{id:"notes",init:function(i){n=i,/receiver/i.test(window.location.search)||(window.location.search.match(/(\?|\&)notes/gi)!==null?e():window.addEventListener("message",o=>{if(!t&&typeof o.data=="string"){let h;try{h=JSON.parse(o.data)}catch{}h&&h.namespace==="reveal-notes"&&h.type==="heartbeat"&&(c=o.source,t&&!t.closed?t.focus():(t=c,window.addEventListener("message",a),r()))}var c}),n.addKeyBinding({keyCode:83,key:"S",description:"Speaker notes view"},function(){e()}))},open:e}};export{ht as default};
