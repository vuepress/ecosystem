import{_ as m,c as v,d,b as e,w as a,r,o as b,a as n,e as s}from"./app-S5ylS0q2.js";const o={};function h(g,l){const t=r("CodeTabs"),i=r("ECharts"),p=r("VPPreview");return b(),v("div",null,[l[17]||(l[17]=d('<h1 id="echarts" tabindex="-1"><a class="header-anchor" href="#echarts"><span>ECharts</span></a></h1><p>Add <a href="https://echarts.apache.org/en/index.html" target="_blank" rel="noopener noreferrer">ECharts</a> support to the Markdown files in your VuePress site.</p><h2 id="installation" tabindex="-1"><a class="header-anchor" href="#installation"><span>Installation</span></a></h2><p>Install <a href="https://echarts.apache.org/en/index.html" target="_blank" rel="noopener noreferrer">ECharts</a> in your project:</p>',4)),e(t,{data:[{id:"pnpm"},{id:"yarn"},{id:"npm"}],"tab-id":"shell"},{title0:a(({value:c,isActive:u})=>l[0]||(l[0]=[s("pnpm")])),title1:a(({value:c,isActive:u})=>l[1]||(l[1]=[s("yarn")])),title2:a(({value:c,isActive:u})=>l[2]||(l[2]=[s("npm")])),tab0:a(({value:c,isActive:u})=>l[3]||(l[3]=[n("div",{class:"language-bash","data-highlighter":"shiki","data-ext":"bash",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[n("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[n("code",{class:"language-bash"},[n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#4078F2","--shiki-dark":"#61AFEF"}},"pnpm"),n("span",{style:{"--shiki-light":"#50A14F","--shiki-dark":"#98C379"}}," add"),n("span",{style:{"--shiki-light":"#986801","--shiki-dark":"#D19A66"}}," -D"),n("span",{style:{"--shiki-light":"#50A14F","--shiki-dark":"#98C379"}}," echarts")])])])],-1)])),tab1:a(({value:c,isActive:u})=>l[4]||(l[4]=[n("div",{class:"language-bash","data-highlighter":"shiki","data-ext":"bash",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[n("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[n("code",{class:"language-bash"},[n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#4078F2","--shiki-dark":"#61AFEF"}},"yarn"),n("span",{style:{"--shiki-light":"#50A14F","--shiki-dark":"#98C379"}}," add"),n("span",{style:{"--shiki-light":"#986801","--shiki-dark":"#D19A66"}}," -D"),n("span",{style:{"--shiki-light":"#50A14F","--shiki-dark":"#98C379"}}," echarts")])])])],-1)])),tab2:a(({value:c,isActive:u})=>l[5]||(l[5]=[n("div",{class:"language-bash","data-highlighter":"shiki","data-ext":"bash",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[n("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[n("code",{class:"language-bash"},[n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#4078F2","--shiki-dark":"#61AFEF"}},"npm"),n("span",{style:{"--shiki-light":"#50A14F","--shiki-dark":"#98C379"}}," i"),n("span",{style:{"--shiki-light":"#986801","--shiki-dark":"#D19A66"}}," -D"),n("span",{style:{"--shiki-light":"#50A14F","--shiki-dark":"#98C379"}}," echarts")])])])],-1)])),_:1}),l[18]||(l[18]=d(`<p>Then enable it via:</p><div class="code-block-with-title"><div class="code-block-title-bar" data-title=".vuepress/config.ts"><span>.vuepress/config.ts</span></div><div class="language-ts line-numbers-mode" data-highlighter="shiki" data-ext="ts" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-ts"><span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">import</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> { </span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75;">markdownChartPlugin</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> } </span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">from</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> &#39;@vuepress/plugin-markdown-chart&#39;</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">\`\`\`</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">:::</span></span></code></pre></div><h3 id="with-scripts" tabindex="-1"><a class="header-anchor" href="#with-scripts"><span>With Scripts</span></a></h3><p>If you need to use script to get the data, you can use <code>js</code> or <code>javascript</code> code block.</p><p>We will expose the echarts instance as <code>echarts</code> in the script, and you are expected to assign the echarts option object to <code>option</code> variable. Also, you can assign <code>width</code> and <code>height</code> variable to set the chart size.</p><div class="language-md" data-highlighter="shiki" data-ext="md" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-md"><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">::: echarts Title</span></span>
<span class="line"></span>
